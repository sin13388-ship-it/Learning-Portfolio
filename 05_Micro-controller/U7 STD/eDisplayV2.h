...
/******************************************************************************/
//#define	 BMTouch								//Skip this Line if Not for BM Touch Module
...
#if fSYS > 8000000	   
	#ifdef BMTouch
		#define ePAUSE	GCC_DELAY(200)				//Delay for eDisplay
	#else	
		#define ePAUSE	GCC_DELAY(65)				//Delay for eDisplay
	#endif
#else
	#ifdef BMTouch
		#define ePAUSE	GCC_DELAY(70)				//Delay for eDisplay
	#else	
		#define ePAUSE	GCC_DELAY(25)				//Delay for eDisplay
	#endif
#endif
*/
#if (fSYS % 80000000)
	#define FreqFactor	 ((fSYS/8000000)+1)
#else
	#define FreqFactor	 (fSYS/8000000)	
#endif

#ifdef BMTouch
	#define ePAUSE	GCC_DELAY(70*(fSYS/8000000))	//Delay for eDisplay
#else	
	#define ePAUSE	GCC_DELAY(25*(fSYS/8000000))	//Delay for eDisplay
#endif
