...
const s8* filter1="/YVTCxxx/led/#";    								//Subscribe Topic,/YVTCxxx/led/下所有主題，修正xxx為自己的學號
#define	SENSOR1	"/YVTCxxx/led/r"									//感測器名稱(1)，修正xxx為自己的學號
#define	SENSOR2	"/YVTCxxx/led/g"									//感測器名稱(2)，修正xxx為自己的學號
#define	SENSOR3	"/YVTCxxx/led/b"									//感測器名稱(3)，修正xxx為自己的學號
#define SensorCNT 3
